...
{if isset($cutoff_sunday)}
  {if !$cutoff_sunday['nodispatch'] && !$cutoff_sunday['exception']}
    <span class="label myparcel-label myparcel-label-success">
          <span class="badge myparcel-badge-success">{$cutoff_sunday['name']|escape:'htmlall':'UTF-8'}</span> {$cutoff_sunday['time']|escape:'htmlall':'UTF-8'}
        </span>
  {elseif $cutoff_sunday['nodispatch']}
    <span class="label myparcel-label myparcel-label-danger">
        <span class="badge myparcel-badge-danger">{$cutoff_sunday['name']|escape:'htmlall':'UTF-8'}</span>
      </span>
  {else}
    <span class="label myparcel-label myparcel-label-warning">
        <span class="badge myparcel-badge-warning">{$cutoff_sunday['name']|escape:'htmlall':'UTF-8'}</span> {$cutoff_sunday['time']|escape:'htmlall':'UTF-8'}
      </span>
  {/if}
{/if}
