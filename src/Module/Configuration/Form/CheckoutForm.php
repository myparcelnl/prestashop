...
{
    public const  CONFIGURATION_ADDRESS_NOT_FOUND        = 'MYPARCELNL_ADDRESS_NOT_FOUND_TITLE';
    public const  CONFIGURATION_CC                       = 'MYPARCELNL_CC';
    public const  CONFIGURATION_CITY                     = 'MYPARCELNL_CITY_TITLE';
    public const  CONFIGURATION_CLOSED                   = 'MYPARCELNL_CLOSED_TITLE';
    public const  CONFIGURATION_DELIVERY_CHOICE          = 'MYPARCELNL_DELIVERY_CHOICE_TITLE';
    public const  CONFIGURATION_DELIVERY_EVENING_TITLE   = 'MYPARCELNL_DELIVERY_EVENING_TITLE';
    public const  CONFIGURATION_DELIVERY_MORNING_TITLE   = 'MYPARCELNL_DELIVERY_MORNING_TITLE';
    public const  CONFIGURATION_DELIVERY_STANDARD_TITLE  = 'MYPARCELNL_DELIVERY_STANDARD_TITLE';
    public const  CONFIGURATION_DELIVERY_TITLE           = 'MYPARCELNL_DELIVERY_TITLE';
    public const  CONFIGURATION_DISCOUNT                 = 'MYPARCELNL_DISCOUNT_TITLE';
    public const  CONFIGURATION_FREE                     = 'MYPARCELNL_FREE_TITLE';
    public const  CONFIGURATION_FROM                     = 'MYPARCELNL_FROM_TITLE';
    public const  CONFIGURATION_HOUSE_NUMBER             = 'MYPARCELNL_HOUSE_NUMBER_TITLE';
    public const  CONFIGURATION_LOAD_MORE                = 'MYPARCELNL_LOAD_MORE_TITLE';
    public const  CONFIGURATION_ONLY_RECIPIENT_TITLE     = 'MYPARCELNL_ONLY_RECIPIENT_TITLE';
    public const  CONFIGURATION_OPENING_HOURS            = 'MYPARCELNL_OPENING_HOURS_TITLE';
