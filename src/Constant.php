...
class Constant
{
    ...
    public const API_LOGGING_CONFIGURATION_NAME            = 'MYPARCELNL_API_LOGGING';
    public const PACKAGE_TYPE_CONFIGURATION_NAME           = 'MYPARCELNL_PACKAGE_TYPE';
    public const ONLY_RECIPIENT_CONFIGURATION_NAME         = 'MYPARCELNL_RECIPIENT_ONLY';
    public const AGE_CHECK_CONFIGURATION_NAME              = 'MYPARCELNL_AGE_CHECK';
    public const PACKAGE_FORMAT_CONFIGURATION_NAME         = 'MYPARCELNL_PACKAGE_FORMAT';
    public const RETURN_PACKAGE_CONFIGURATION_NAME         = 'MYPARCELNL_RETURN_PACKAGE';
    public const SIGNATURE_REQUIRED_CONFIGURATION_NAME     = 'MYPARCELNL_SIGNATURE_REQUIRED';
    public const INSURANCE_CONFIGURATION_NAME              = 'MYPARCELNL_INSURANCE';
    public const INSURANCE_CONFIGURATION_FROM_PRICE        = 'MYPARCELNL_INSURANCE_FROM_PRICE';
    public const INSURANCE_CONFIGURATION_MAX_AMOUNT        = 'MYPARCELNL_INSURANCE_MAX_AMOUNT';
    public const INSURANCE_CONFIGURATION_BELGIUM           = 'MYPARCELNL_INSURANCE_BELGIUM';
    public const CUSTOMS_FORM_CONFIGURATION_NAME           = 'MYPARCELNL_CUSTOMS_FORM';
    public const CUSTOMS_FORM_CONFIGURATION_OPTION_ADD     = 'Add';
    public const CUSTOMS_FORM_CONFIGURATION_OPTION_SKIP    = 'Skip';
    public const CUSTOMS_CODE_CONFIGURATION_NAME           = 'MYPARCELNL_CUSTOMS_CODE';
    public const DEFAULT_CUSTOMS_CODE_CONFIGURATION_NAME   = 'MYPARCELNL_DEFAULT_CUSTOMS_CODE';
    public const CUSTOMS_ORIGIN_CONFIGURATION_NAME         = 'MYPARCELNL_CUSTOMS_ORIGIN';
    public const DEFAULT_CUSTOMS_ORIGIN_CONFIGURATION_NAME = 'MYPARCELNL_DEFAULT_CUSTOMS_ORIGIN';
    ...
    public const SHARE_CUSTOMER_EMAIL_CONFIGURATION_NAME                = 'MYPARCELNL_SHARE_CUSTOMER_EMAIL';
    public const SHARE_CUSTOMER_PHONE_CONFIGURATION_NAME                = 'MYPARCELNL_SHARE_CUSTOMER_PHONE';
    public const USE_ADDRESS2_AS_STREET_NUMBER_CONFIGURATION_NAME       = 'MYPARCELNL_USE_ADDRESS2_AS_STREET_NUMBER';
    public const CONCEPT_FIRST                                          = 'MYPARCELNL_CONCEPT_FIRST';

    public const DELIVERY_OPTIONS_PRICE_FORMAT_CONFIGURATION_NAME = 'MYPARCELNL_DELIVERY_OPTIONS_PRICE_FORMAT';
    ...
    public const LABEL_DESCRIPTION_CONFIGURATION_NAME          = 'MYPARCELNL_LABEL_DESCRIPTION';
    public const LABEL_OPEN_DOWNLOAD_CONFIGURATION_NAME        = 'MYPARCELNL_LABEL_OPEN_DOWNLOAD';
    public const LABEL_SIZE_CONFIGURATION_NAME                 = 'MYPARCELNL_LABEL_SIZE';
    public const LABEL_POSITION_CONFIGURATION_NAME             = 'MYPARCELNL_LABEL_POSITION';
    public const LABEL_PROMPT_POSITION_CONFIGURATION_NAME      = 'MYPARCELNL_LABEL_PROMPT_POSITION';
    public const LABEL_CREATED_ORDER_STATUS_CONFIGURATION_NAME = 'MYPARCELNL_LABEL_CREATED_ORDER_STATUS';
    ...
    public const STATUS_CHANGE_MAIL_CONFIGURATION_NAME                  = 'MYPARCELNL_STATUS_CHANGE_MAIL';
    public const SENT_ORDER_STATE_FOR_DIGITAL_STAMPS_CONFIGURATION_NAME = 'MYPARCELNL_SENT_ORDER_STATE_FOR_DIGITAL_STAMPS';
    public const LABEL_SCANNED_ORDER_STATUS_CONFIGURATION_NAME          = 'MYPARCELNL_LABEL_SCANNED_ORDER_STATUS';
    public const DELIVERED_ORDER_STATUS_CONFIGURATION_NAME              = 'MYPARCELNL_DELIVERED_ORDER_STATUS';
    public const ORDER_NOTIFICATION_AFTER_CONFIGURATION_NAME            = 'MYPARCELNL_ORDER_NOTIFICATION_AFTER';
    ...
    public const CARRIER_EXCLUSIVE              = [
        'POSTNL' => [
            ...
            'return_' . self::PACKAGE_TYPE_CONFIGURATION_NAME       => [
                'BE' => false,
                'NL' => [1 => true, 2 => true, 3 => false, 4 => false],
            ],
